    ...
    return (
        <div className="relative min-h-screen">
                ...
                <div className="max-w-[1200px] mx-auto px-6 w-full">
                    <div className="text-center max-w-[800px] mx-auto">
                        ...
                        <div className="animate-fade-in-up delay-3 flex items-center justify-center gap-4 flex-wrap">
                            <Link to="/auth" className="inline-flex items-center gap-2 px-10 py-[18px] bg-neon-blue text-black font-bold text-lg rounded-2xl btn-glow transition-all active:scale-[0.97]">
            ...
            <section id="features" className="py-24">
                <div className="max-w-[1200px] mx-auto px-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            { title: '7-Day Action Plans', desc: 'Personalized weekly roadmaps tailored to your target roles, skills, and deadlines.' },
                            { title: 'Mock Interviews', desc: 'Role-specific practice sessions with real-time feedback and curated questions.' },
                            { title: 'ATS Resume Tips', desc: 'Get your resume past automated screening with smart, actionable suggestions.' },
                            { title: 'Readiness Score', desc: 'Track your placement readiness with shareable cards and competitive leaderboards.' },
                        ].map((f, i) => (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className={`glass-card text-center p-8 animate-fade-in-up delay-${i + 1}`}>
                                <div className="text-3xl font-display font-extrabold gradient-text mb-5">{s.num}</div>
            ...
            <section className="py-24">
                <div className="max-w-[1200px] mx-auto px-6">
                    <div className="animate-fade-in-up relative p-16 bg-white/3 border border-white/8 rounded-3xl text-center overflow-hidden">
                        <div className="absolute inset-[-2px] bg-neon-blue rounded-[inherit] -z-10 opacity-15" />
            ...
            <footer className="py-8 border-t border-white/8 text-center">
                <div className="max-w-[1200px] mx-auto px-6">
                    <p className="text-sm text-gray-500">&copy; 2026 <Link to="/" className="text-neon-blue hover:text-neon-cyan transition-colors">Prep-Pilot</Link>. Built to help you get placed.</p>
                </div>
            </footer>
        </div>
    )
